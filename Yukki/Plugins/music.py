...
async def play(_, message: Message):
    ...
    if updates_channel:
        try:
            ...
            await app.send_message(chat_id, "👋🏻 Hello {} to avoid overuse, first you must join our channel, then you can play music.".format(message.from_user.mention()), reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📣 Join channel first.", url=f"https://t.me/{update_channel}")]]))
            return
